...
obs_achievement <- obs_achievement %>% mutate(월 = month(obs_achievement$일자)) %>% # 월 추가
...
# 엑셀 파일 내보내기_writexl
write_xlsx(list("BOD" = BOD_achievement, "TP" = TP_achievement, "TOC" = TOC_achievement), path = "Output/Data/달성률평가.xlsx")
