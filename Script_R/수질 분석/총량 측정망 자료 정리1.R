...
# 기존 데이터
base <- read_excel("수질 분석/총량측정망0723.xlsx") %>% 
  filter(연도 != 2023)

# 2023년 자료
data_2023 <- read_excel("수질 분석/자료 조회_2023.xlsx", skip = 1)
...
data <- base %>% bind_rows(data_2023_1)


## 엑셀 파일 내보내기_writexl
write_xlsx(data, path = "수질 분석/총량측정망0723_1.xlsx")
