...
files <- list.files(
  path = "수질분석/",
  pattern = "오염우심하천*", full.names = T
)

obs_우심 <- read_excel(files) %>% 
...
obs_우심1 <- obs_우심 %>%
  ...
  mutate(지점번호 = factor(지점번호, levels = c(1:26)))


###################  그래프 작성  ##############################################

### 오대천 그래프 ------------------------------------------------------------------------------
pdf("E:/Coding/TMDL/수질분석/Output/Plot/오염우심하천/오대천.pdf", 
...
### 섬강 그래프 --------------------------------------------------------------------------------
pdf("E:/Coding/TMDL/수질분석/Output/Plot/오염우심하천/섬강.pdf", 
    width = 8.1, height = 5.9)
...
# pdf("E:/Coding/TMDL/수질분석/Output/Plot/오염우심하천_섬강A.pdf",
#     width = 8.4, height = 6)
...
### 한탄강 그래프 ------------------------------------------------------------------------------
pdf("E:/Coding/TMDL/수질분석/Output/Plot/오염우심하천/한탄강.pdf", 
    width = 8.1, height = 5.9)
...
### 인북천 그래프 ------------------------------------------------------------------------------
pdf("E:/Coding/TMDL/수질분석/Output/Plot/오염우심하천/인북천.pdf", 
    width = 8.1, height = 5.9)
...
### 주천강 그래프 ------------------------------------------------------------------------------
pdf("E:/Coding/TMDL/수질분석/Output/Plot/오염우심하천/주천강.pdf", 
    width = 8.1, height = 5.9)

# 주천 BOD 그래프
obs_우심1 %>% filter(유역 == "주천") %>% 
  ggplot(aes(x = 지점번호, y = BOD)) +
  # staplewidth : 박스플롯이 수염이 끝나는 지점 표시 너비
  geom_boxplot(outliers = FALSE, staplewidth = 0.3) +
  geom_jitter(aes(fill = 계절), shape = 21, alpha = 0.6, size = 1.8,
