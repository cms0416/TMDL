...
base <- read_excel("수질분석/총량측정망_2007_2023.xlsx")

# 2024년 자료
data_new <- read_excel("수질분석/자료조회_2024.xlsx", skip = 1)

# data_2020_2021 <- read_excel("수질분석/자료조회_2020_2021.xlsx", skip = 1)
# data_2022_2023 <- read_excel("수질분석/자료조회_2022_2023.xlsx", skip = 1)

# data_new <- data_2020_2021 %>% bind_rows(data_2022_2023)
...
###  엑셀 파일 내보내기_writexl  ###############################################
write_xlsx(data, path = "수질분석/총량측정망_2007_2024.xlsx")

write_xlsx(data_강원, path = "수질분석/총량측정망_강원_2007_2024.xlsx")
