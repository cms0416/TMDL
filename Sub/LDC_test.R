...
FLOW <- read_excel("D:/1. 수질총량/2. 기준유량/기준유량 구간최대값_test.xlsx")
...
# 데이터 csv로 내보내기
write.csv(TP_group, file = "D:/1. 수질총량/3. 목표수질/총량측정망 수질 현황 정리/TP_LDC_test.csv")
write.csv(BOD_group, file = "D:/1. 수질총량/3. 목표수질/총량측정망 수질 현황 정리/BOD_LDC_test.csv")
