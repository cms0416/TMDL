...
###  엑셀 파일 내보내기_writexl
write_xlsx(alldata_s, path = "Output/Data/전국오염원조사/전국오염원조사 자료 정리(시군기준).xlsx")
...
livestock_sum_s2 <- livestock_sum_s1 %>%
  ...
  summarise_at(vars(`2014`:`2021`), funs(sum)) %>% 
  mutate(분류 = "분류")
...
###  엑셀 파일 내보내기_writexl
write_xlsx(alldata_s2, path = "Output/Data/전국오염원조사/전국오염원조사자료 계별 대표값 정리(유역기준).xlsx")
